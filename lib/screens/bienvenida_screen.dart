      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double anchoContenido = constraints.maxWidth.clamp(0.0, 520.0).toDouble();
            ...
            return SingleChildScrollView(
              padding: 
                ...
                child: 
                ConstrainedBox(
                constraints: BoxConstraints(minHeight: (constraints.maxHeight - (compacto ? 32 : 60)).clamp(0.0, double.infinity).toDouble()),
                child: Center(
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Control de Inventario', textAlign: TextAlign.center, style: TextStyle(fontSize: constraints.maxWidth < 360 ? 18 : 22, letterSpacing: 2)),
                        SizedBox(height: compacto ? 18 : 35),
                        Text('Inventario de Libreria Y Novedades Emanuel', textAlign: TextAlign.center, style: TextStyle(fontSize: constraints.maxWidth < 360 ? 14 : 16, color: Colors.black54)),
                        ...
                        const Wrap(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text('Solo personal autorizado', style: TextStyle(color: Colors.blueGrey)),
                          ],
                        ),
                      ],
                    ),
